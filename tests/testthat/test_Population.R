...
test_that("QTLs are selected correctly", {
  ...
  pop = Population(popSize = 2, map=map1, QTL=qtls, alleleFrequencies = runif(100), broadH2 = 0.9,
                   narrowh2 = 0.6, traitVar = 40)
...
test_that("Correct number of QTLs are selected randomly", {
  pop = Population(popSize = 2, map=map100snp, QTL=20, alleleFrequencies = runif(100), broadH2 = 0.9,
                   narrowh2 = 0.6, traitVar = 40)
...
test_that("No heritability gives correct environmental mean and variance", {
  pop = Population(popSize = 10, map=map100snp, QTL=20, alleleFrequencies = runif(100), broadH2 = 0,
