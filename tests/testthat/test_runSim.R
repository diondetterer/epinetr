...
test_that("Lack of necessary additive effects produces error", {
  pop = Population(popSize = 10, map=map100snp, QTL=20, alleleFrequencies = runif(100), broadH2 = 0.9,
...
test_that("Running with a single chromosome works", {
  ...
  pop = Population(popSize = 250, map = map1, QTL = 20, alleleFrequencies = runif(100), broadH2 = 0.9,
